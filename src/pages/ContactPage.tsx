  ...
  return (
    <div className="min-h-screen bg-[#f8f8f3]">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <h1 className="font-display text-4xl text-slate-900">יצירת קשר והרשמה</h1>
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <form className="space-y-3 rounded-2xl bg-white p-6 shadow">
            <input className="input" placeholder="שם מלא" />
            <input className="input" type="email" placeholder="אימייל" />
            <input className="input" placeholder="מספר וואטסאפ" />
            <select className="input"><option>בחרו קורס</option><option>מתחילים</option><option>מתקדמים</option><option>מתקדם</option></select>
            <textarea className="input min-h-[120px]" placeholder="ספרו לנו על הרקע והיעדים שלכם" />
            <button className="w-full rounded-xl bg-amber-500 py-3 font-semibold text-slate-900 hover:bg-amber-400">בקשה לשיחת הרשמה</button>
          </form>
          <aside className="rounded-2xl bg-[#041b34] p-6 text-cyan-50 shadow">
            <h2 className="text-2xl font-semibold">צוללים באחריות</h2>
            <p className="mt-2 text-sm text-cyan-100">אזורי פעילות: חיפה, הרצליה, אילת וסשנים עונתיים מסירה.</p>
