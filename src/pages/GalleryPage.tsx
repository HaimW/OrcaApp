...
const tiles = ['אימון צלילה חופשית', 'דיג במים כחולים', 'תדריך סירה', 'מפגש קהילתי', 'תרגולי בטיחות', 'חקר שונית האלמוגים'];
  ...
  return (
    <div className="min-h-screen bg-[#f8f8f3]">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <p className="mt-2 text-slate-600">צלילות, מסעות ורגעים מהקהילה.</p>
