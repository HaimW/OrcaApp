  ...
  return (
    <footer className="border-t border-slate-700 bg-[#051327] text-slate-200">
      <div className="mx-auto grid max-w-6xl gap-6 px-4 py-10 md:grid-cols-3">
        <div>
          <h4 className="font-display text-lg text-white">קהילת הצלילה אורקה</h4>
          <p className="mt-2 text-sm text-slate-300">פרידייבינג ודייג אחראי עם דגש על בטיחות, מקצועיות ושמירה על הים.</p>
        </div>
        <div>
          <h5 className="font-semibold text-white">מידע מהיר</h5>
          <ul className="mt-2 space-y-1 text-sm">
            <li>אזור פעילות: הים התיכון ואילת</li>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-1 text-sm">
            ...
            <li>דוא״ל: hello@orcasdive.com</li>
          </ul>
        </div>
      </div>
    </footer>
